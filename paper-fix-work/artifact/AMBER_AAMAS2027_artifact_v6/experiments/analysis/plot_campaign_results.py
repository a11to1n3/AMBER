...
def plot_attestation():
    ...
    fig.suptitle("Semantic attestation — host_a", fontsize=12, y=1.02)
    fig.tight_layout()
...
def plot_performance():
    ...
    fig.suptitle("C4 — Native-idiom performance (host_a, RTX 3090)", fontsize=12, y=1.02)
    fig.tight_layout()
...
def plot_claims_dashboard():
    ...
    ax.set_xlim(0, 1)
    ax.set_xticks([])
    ax.set_title("Campaign claim dashboard — host_a / RTX 3090")
    fig.tight_layout()
